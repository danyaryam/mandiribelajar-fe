...
export const metadata: Metadata = {
  ...
  description:
    'Mandiri Belajar adalah platform latihan soal berbasis AI untuk pelajar SD/MI, SMP/MTs, dan SMA/MA. Latihan soal, koreksi otomatis, dan penjelasan untuk belajar mandiri.',
  openGraph: {
    type: 'website',
